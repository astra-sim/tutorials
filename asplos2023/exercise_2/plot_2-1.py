...
def main():
    ...
    df = pd.read_csv('./result_2-1/tutorial_result.csv')
    ...
    # save the plot
    fig.savefig(os.path.join('./result_2-1', 'plot_2-1.png'))
    fig.savefig(os.path.join('./result_2-1', 'plot_2-1.pdf'))
    fig.clf()
    plt.close(fig=fig)

    # show the log
    print("Result saved at ./result_2-1")
